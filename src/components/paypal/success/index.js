                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div className="row margin-top-20px margin-bottom-50px">
                                <div className="col-lg-8 col-md-8 col-sm-12">
                                    ...
                                    }
                                    {
                                        sort(this.props.cart).map( item =>
                                            <div className="col-lg-12 col-md-12 col-sm-12 margin-bottom-20px" key={item.id}>
                                                ...
                                                <div className="col-lg-8 col-md-8 col-sm-12 padding-top-20px text-center">
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-12 col xs-24">
                                    ...
                                    <p>There is a 100% money back garuntee if for any reason you are not satisfied with your products. Just return the item in the condition you recieved it to<br /><br /><h4>Returns</h4><br />13066 Paddy Creek Ln<br />Lodi, CA 95240.</p>
                                </div>
                            </div>
                        </div>
                    </div>
